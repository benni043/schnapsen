...
import {UserData} from "../../../sources/utils";
...
export class SettingsService {
  ...
  join(player: string, server: number) {
    this.socket.emit("join", {player: player, server: server, ws: this.socket});
  }
